...
class LawyerSettingScreen extends StatelessWidget {
  const LawyerSettingScreen({super.key});
                              ...
                              child: Column(
                                children: [
                                  _listTileSwitch(
                                    ...
                                    "In-app Notification", 
                                    CupertinoSwitch(
                                      value: controller.lawyer.inAppNotifcations!,
                                      onChanged: (value) {
                                        controller.updateLawyerInAppNotificaton();
                                      },
                                    )
                                  ),
                                  _listTileSwitch(
                                    ...
                                    "Email Notification", 
                                    CupertinoSwitch(
                                      value: controller.lawyer.emailNotifcations!,
                                      onChanged: (value) {
                                        controller.updateLawyerEmailNotificaton();
                                      },
                                    )
                                  ),
                                ],
                              ...
                              child: Column(
                                children: [
                                  _listTileArrow(
                                    ...
                                    "Password",
                                    () {
                                      Get.toNamed(lawyerUpdatePasswordScreen);
                                    }
                                  ),
                                  _listTileSwitch(
                                    Container(
                          ...
                          Flexible(
                            child: Container(
                              ...
                              child: _listTileSwitch(
                                ...
                                CupertinoSwitch(
                                  value: controller.lawyer.privateMode!,
                                  onChanged: (value) {
