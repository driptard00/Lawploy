...
class LawFirmSettingScreen extends StatelessWidget {
  const LawFirmSettingScreen({super.key});
                            ...
                            child: Column(
                              children: [
                                _listTileSwitch(
                                  ...
                                  "In-app Notification", 
                                  CupertinoSwitch(
                                    value: controller.lawFirm.inAppNotifcations!,
                                    onChanged: (value) {
                                      controller.updateFirmInAppNotifcation();
                                    },
                                  )
                                ),
                                _listTileSwitch(
                                  ...
                                  "Email Notification", 
                                  CupertinoSwitch(
                                    value: controller.lawFirm.emailNotifcations!,
                                    onChanged: (value) {
                                      controller.updateFirmInEmaillNotifcation();
                                    },
                                  )
                                ),
                              ],
                            ...
                            child: Column(
                              children: [
                                _listTileArrow(
                                  ...
                                  "Password",
                                  () {
                                    Get.toNamed(firmUpdatePasswordScreen);
                                  }
                                ),
                                _listTileSwitch(
                                  Container(
                        ...
                        Flexible(
                          child: Container(
                            ...
                            child: _listTileSwitch(
                              ...
                              CupertinoSwitch(
                                value: controller.lawFirm.privateMode!,
                                onChanged: (value) {
