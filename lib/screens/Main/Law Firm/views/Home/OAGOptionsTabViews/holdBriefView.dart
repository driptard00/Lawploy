...
class OAGHoldBriefView extends StatelessWidget {
  const OAGHoldBriefView({super.key});
          ...
          body: Container(
            child: Column(
              children: [
                ...
                Expanded(
                  child: (controller.oagLawyersList.isEmpty)?
                  const Center(
                    child: Text(
                      "No Lawyers Found"
                    ),
                                              ...
                                              child: TextButton(
                                                onPressed: () {
                                                  Get.toNamed(
                                                    ...
                                                    arguments: {
                                                      "userId": controller.oagLawyersList[index]["_id"],
                                                      "userAuth": controller.oagLawyersList[index]["_auth"],
                                                    }
                                                  );
                                                },
