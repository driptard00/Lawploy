...
import '../../../../../services/flutter_wave/flutter_wave_service.dart';

class LFProfileHoldBriefScreen extends StatelessWidget {
  LFProfileHoldBriefScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      _lawFirmStateController.getSingleLawyer(userId);
    },);
