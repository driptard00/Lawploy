...
class ArdHoldBriefView extends StatelessWidget {
  const ArdHoldBriefView({super.key});
          ...
          body: Container(
            child: Column(
              children: [
                ...
                Expanded(
                  child: (controller.adrLawyersList.isEmpty)?
                  const Center(
                    child: Text(
                      "No Lawyers Found"
                    ),
                                              ...
                                              child: TextButton(
                                                onPressed: () {
                                                  Get.toNamed(
                                                    ...
                                                    arguments: {
                                                      "userId": controller.adrLawyersList[index]["_id"],
                                                      "userAuth": controller.adrLawyersList[index]["_auth"],
                                                    }
                                                  );
                                                },
