...
class AllHoldBriefView extends StatelessWidget {
  const AllHoldBriefView({super.key});
                    ...
                    child: Column(
                      children: [
                        GridView.builder(
                          ...
                          itemCount: (controller.lawyersList.length > 4)? 4 : controller.lawyersList.length,
                                              ...
                                              child: TextButton(
                                                onPressed: () {
                                                  Get.toNamed(
                                                    ...
                                                    arguments: {
                                                      "userId": controller.lawyersList[index]["_id"],
                                                      "userAuth": controller.lawyersList[index]["_auth"],
                                                    }
                                                  );
                                                },
                        ...
                        (controller.lawyersList.length > 4)?
                        SizedBox(
                          height: 50,
                          width: Get.width,
                          child: TextButton(
