...
class LFProfileScreen extends StatelessWidget {
  const LFProfileScreen({super.key});
                        ...
                        child: Column(
                          children: [
                            _listTile(
                              ...
                              (){
                                Get.toNamed(lfeditProfileScreen);
                              }
                            ),
                            _listTile(
                              Container(
                            ...
                            _listTile(
                              ...
                              () {
                                Get.toNamed(lawFirmSettingScreen);
                              }
                            ),
                            _listTile(
                              Container(
