                            ...
                            child: Column(
                              children: [
                                _listTileSwitch(
                                  ...
                                  "In-app Notification", 
                                  CupertinoSwitch(
                                    value: controller.corporation.inAppNotifcations!,
                                    onChanged: (value) {
                                ...
                                _listTileSwitch(
                                  ...
                                  "Email Notification", 
                                  CupertinoSwitch(
                                    value: controller.corporation.emailNotifcations!,
                                    onChanged: (value) {
                            ...
                            child: Column(
                              children: [
                                _listTileArrow(
                                  ...
                                  "Password",
                                  () {
                                    Get.toNamed(companyUpdatePasswordScreen);
                                  }
                                ),
                                _listTileSwitch(
                                  Container(
                        ...
                        Flexible(
                          child: Container(
                            ...
                            child: _listTileSwitch(
                              ...
                              CupertinoSwitch(
                                value: controller.corporation.privateMode!,
                                onChanged: (value) {
                                  controller.updateCompanyVisibility();
                                },
                              )
                            ),
                          ),
