...
class CompanyFinanceViews extends StatelessWidget {
  const CompanyFinanceViews({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CompanyStateController>(
      builder: (controller) {
        return (controller.financeLawyersList.isEmpty)?
        const Center(
          child: Text(
            "No Lawyers Found"
          ),
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "${controller.financeLawyersList[index]["state"]}, ${controller.financeLawyersList[index]["country"]}",
                                    maxLines: 1,
