...
class PICorporateViews extends StatelessWidget {
  const PICorporateViews({super.key});
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "${controller.corporateLawyersList[index]["state"]}, ${controller.corporateLawyersList[index]["LGA"]}",
                                    maxLines: 1,
